...
void setup()
{
  ...
  //Now use the start up sound
  int melody[] = {262, 294, 330, 349, 392}; // Frequencies in Hz for a simple melody (C4, D4, E4, F4, G4)
  int noteDurations[] = {4, 8, 8, 4, 4}; // Duration of each note (in terms of quarter note, eighth note, etc.)
  ...
  Serial.println("initializing mic sampler");
  ...
  Serial.println("initializing mic output");
  ...
  Serial.println("initializing indicator");

  IndicatorLight *indicator_light = new IndicatorLight();
  
  Serial.println("initializing intent");
